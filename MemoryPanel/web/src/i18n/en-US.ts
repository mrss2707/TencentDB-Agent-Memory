...
export const enUS = {
  ...
  'settings.llm.title': 'LLM Backend Configuration',
  'settings.llm.desc':
    'Memory uses these to distill daily logs into long-term memory (L1/L2/L3). URLs and API keys stay in your browser and are never written back to the panel; editing .env files requires a container restart.',
  'settings.llm.card.memory': 'Memory LLM',
  'settings.llm.card.memory.desc': 'Daily distillation of conversations into L1/L2/L3 long-term memory.',
  'settings.llm.card.proxy': 'Proxy Upstream',
  'settings.llm.card.proxy.desc': 'LLM gateway the proxy forwards to for external agents.',
  'settings.llm.card.knowledge': 'Knowledge Binding (MemoryKnowledge)',
  'settings.llm.card.knowledge.desc': 'Per-service binding for knowledge extraction/query.',
  ...
  'settings.llm.checkCompatibility': 'Check Compatibility',
  'settings.llm.testing': 'Testing…',
  'settings.llm.checking': 'Checking…',
  'settings.llm.restartRequired': 'restart-required',
  'settings.llm.liveUpdate': 'live-updatable',
  'settings.llm.envSnippet': '.env snippet',
  'settings.llm.copy': 'Copy',
  'settings.llm.copied': 'Copied',
  'settings.llm.revealKey': 'Reveal key in snippet',
  'settings.llm.hideKey': 'Hide key',
  'settings.llm.proxyAdvisory':
    'The proxy forwards requests as-is (OpenAI semantics); its protocol follows the requester, so the protocol selection here only affects the connection test.',
  'settings.llm.anthropicNeedsModel': 'Anthropic protocol requires a model to test. The model you enter is used by Anthropic; OpenAI-framed endpoints are not affected.',
  'settings.llm.compat.ok': 'Compatible — no errors.',
  'settings.llm.compat.failed': 'Compatibility check found issues:',
  'settings.llm.kb.mode': 'Binding mode',
  'settings.llm.kb.mode.proxy': 'Proxy prefix',
  'settings.llm.kb.mode.byo': 'Direct (BYO)',
  'settings.llm.kb.proxyBaseUrl': 'Proxy base URL',
  'settings.llm.kb.byoBaseUrl': 'Provider base URL',
  'settings.llm.kb.enabled': 'Binding enabled',
  'settings.llm.kb.hasKey': 'Key stored',
  'settings.llm.kb.noKey': 'No key stored',
  'settings.llm.kb.keyFirstSet': 'API key is required on first save; leave blank to keep the stored key.',
  'settings.llm.kb.modelGlobal':
    'Model and protocol for knowledge come from global LLM_* environment variables (not per service) — changing them requires editing .env and restarting memory-hub.',
  'settings.llm.kb.load': 'Load',
  'settings.llm.kb.save': 'Save Binding',
  'settings.llm.kb.loading': 'Loading binding…',
  'settings.llm.kb.saving': 'Saving…',
  'settings.llm.kb.notBound': 'Not bound yet — choose a mode and save.',
  'settings.llm.kb.loadFailed': 'Failed to load binding: {{msg}}',
  'settings.llm.kb.saveFailed': 'Failed to save binding: {{msg}}',
  'settings.llm.kb.saved': 'Binding saved',
